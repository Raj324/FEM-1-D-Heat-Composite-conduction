...
//	printf("Kal pre  : %f \n", kalpre);
	...
	for(p=0;p<(e/2);p++)
   {
   printf("Enter the elements of local siffness matrix for aluminium \n");
  ...
  printf("\n");
	...
	// assembling of stiffness matrix of Aluminium
  printf("The global stiffness matrix for aluminum : \n");
	...
	// Stiffness matrix for copper
	kcupre = (kxCu*area)/deltax ;
	
	for(p=(e/2);p<e ;p++)
   {
 printf("Enter the elements of local siffness matrix  for copper\n");
...
// assembling of stiffness matrix of copper
 

  printf("The global stiffness matrix for copper : \n");
...
// complete assembling
 printf("The global stiffness matrix : \n");
